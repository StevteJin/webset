...
<style>
.dnfxxbox .el-table tr {
  height: 24px;
  background-color: rgb(31, 31, 31);
}
.dnfxxbox .el-table tr:hover {
  background: none;
}
.dnfxxbox .el-table--border {
  border: none;
}
.dnfxxbox .el-table--striped .el-table__body tr.el-table__row--striped td {
  background: #2e2e30;
}
.dnfxxbox .el-table--border::after {
  background-color: rgb(67, 67, 67);
}
.dnfxxbox .el-table--enable-row-hover .el-table__body tr:hover > td {
  background-color: transparent;
}
.dnfxxbox .el-table th.is-leaf {
  border: 1px solid rgb(67, 67, 67);
  border-left: none;
}

.dnfxxbox .el-pagination button:disabled {
  background-color: rgb(46, 46, 48);
}
.dnfxxbox .el-pager li {
  color: #c0c4cc;
}
.dnfxxbox .el-pager li.active {
  color: #fff !important;
...
.dnfxxbox .el-pagination .btn-next {
  background-color: rgb(46, 46, 48);
  float: right;
  color: #c0c4cc;
  width: 168px;
...
.dnfxxbox .el-pagination .btn-prev {
  background-color: rgb(46, 46, 48);
  float: left;
  color: #c0c4cc;
  width: 168px;
...
.dnfxxbox .el-table::before {
  background-color: rgb(17, 17, 19);
}
.dnfxxbox .el-pagination {
  position: absolute;
  width: 100%;
}
</style>
